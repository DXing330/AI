...
def ok(x, y):
    if 0 <= x <= c.BLOCK_SIZE and 0 <= y <= c.BLOCK_SIZE:
        return True
    return False
...
class Snake:
    ...
    def move(self):
        ...
        if self.snake[0].x == self.fruit.pos.x and self.snake[0].y == self.fruit.pos.y:
            self.tail += 1
            self.score += 1
            self.eat = True
            self.generate()
        # Game over cases
        if self.snake[0].x >= c.BLOCK_SIZE:
            self.gameOver = 1
        if self.snake[0].y >= c.BLOCK_SIZE:
            self.gameOver = 1
        if self.snake[0].x < 0:
            self.gameOver = 1
        if self.snake[0].y < 0:
    ...
    def vision(self):
        ...
        if self.direction == 0:
            ...
            while ok(x, y) and run:
                ...
                y += 1
                x -= 1
            output.append(min(d, (distance(self.snake[0].x, 0, self.snake[0].y, c.BLOCK_SIZE))))
            # 7(Forward)
            d = 100
            x = self.snake[0].x
            y = self.snake[0].y + 1
            ...
            while ok(x, y) and run:
                for i in range(1, self.tail + 1):
                    if x == self.snake[i].x and y == self.snake[i].y:
                        ...
                        break
                y += 1
            output.append(min(d, (c.BLOCK_SIZE - self.snake[0].y - 1)))
            # (ForwardLeft)
            d = 100
            x = self.snake[0].x + 1
            y = self.snake[0].y + 1
            ...
            while ok(x, y) and run:
                ...
                x += 1
                y += 1
            output.append(min(d, (distance(self.snake[0].x, c.BLOCK_SIZE, self.snake[0].y, c.BLOCK_SIZE))))
            # (Left)
            d = 100
            x = self.snake[0].x + 1
            y = self.snake[0].y
            ...
            while ok(x, y) and run:
                for i in range(1, self.tail + 1):
                    if x == self.snake[i].x and y == self.snake[i].y:
                        ...
                        break
                x += 1
            output.append(min((c.BLOCK_SIZE - self.snake[0].x - 1), d))

        if self.direction == 1:
            # Distance to the food
            output.append(self.snake[0].y - self.fruit.pos.y - 1)  # Right
            if self.fruit.pos.x <= (self.snake[0].x - 1) and self.fruit.pos.y <= (self.snake[0].y - 1):
                output.append(
                    distance(self.snake[0].x - 1, self.fruit.pos.x, self.snake[0].y - 1,
                             self.fruit.pos.y))  # Forward Right
            else:
                output.append(
                    - distance(self.snake[0].x - 1, self.fruit.pos.x, self.snake[0].y - 1,
                               self.fruit.pos.y))  # Forward Right
            output.append(self.snake[0].x - self.fruit.pos.x - 1)  # Forward
            if self.fruit.pos.x <= (self.snake[0].x - 1) and self.fruit.pos.y >= (self.snake[0].y + 1):
                output.append(
                    distance(self.snake[0].x - 1, self.fruit.pos.x, self.snake[0].y + 1,
                             self.fruit.pos.y))  # Forward Left
            else:
                output.append(
                    - distance(self.snake[0].x - 1, self.fruit.pos.x, self.snake[0].y + 1,
                               self.fruit.pos.y))  # Forward Left
            output.append(self.fruit.pos.y - self.snake[0].y - 1)  # Left
        ...
        if self.direction == 2:
            # Distance to the food
            output.append(self.fruit.pos.y - self.snake[0].y - 1)  # Right
            if self.fruit.pos.x >= (self.snake[0].x + 1) and self.fruit.pos.y >= (self.snake[0].y + 1):
                output.append(
                    distance(self.snake[0].x + 1, self.fruit.pos.x, self.snake[0].y + 1,
                             self.fruit.pos.y))  # Forward Right
                ...
                output.append(
                    - distance(self.snake[0].x + 1, self.fruit.pos.x, self.snake[0].y + 1,
                               self.fruit.pos.y))  # Forward Right
            output.append(self.fruit.pos.x - self.snake[0].x - 1)  # Forward
            if self.fruit.pos.x >= (self.snake[0].x + 1) and self.fruit.pos.y <= (self.snake[0].y - 1):
                output.append(
                    distance(self.snake[0].x + 1, self.fruit.pos.x, self.snake[0].y - 1,
                             self.fruit.pos.y))  # Forward left
                ...
                output.append(
                    - distance(self.snake[0].x + 1, self.fruit.pos.x, self.snake[0].y - 1,
                               self.fruit.pos.y))  # Forward left
            output.append(self.snake[0].y - self.fruit.pos.y - 1)  # Left
            ...
            while ok(x, y) and run:
                for i in range(1, self.tail + 1):
                    if x == self.snake[i].x and y == self.snake[i].y:
                        ...
                        break
                x += 1
            output.append(min(d, (c.BLOCK_SIZE - self.snake[0].x - 1)))
            ...
            while ok(x, y) and run:
                ...
                y -= 1
                x += 1
            output.append(min(d, (distance(self.snake[0].x, c.BLOCK_SIZE, self.snake[0].y, 0))))
        ...
        if self.direction == 3:
            # Distance to the food
            output.append(self.fruit.pos.x - self.snake[0].x - 1)  # Right
            if self.fruit.pos.x >= (self.snake[0].x + 1) and self.fruit.pos.y <= (self.snake[0].y - 1):
                output.append(
                    distance(self.snake[0].x + 1, self.fruit.pos.x, self.snake[0].y - 1,
                             self.fruit.pos.y))  # Forward Right
                ...
                output.append(
                    - distance(self.snake[0].x + 1, self.fruit.pos.x, self.snake[0].y - 1,
                               self.fruit.pos.y))  # Forward Right
            output.append(self.snake[0].y - self.fruit.pos.y - 1)  # Forward
            if self.fruit.pos.x <= (self.snake[0].x - 1) and self.fruit.pos.y <= (self.snake[0].y - 1):
                output.append(
                    distance(self.snake[0].x - 1, self.fruit.pos.x, self.snake[0].y - 1,
                             self.fruit.pos.y))  # Forward Left
                ...
                output.append(
                    - distance(self.snake[0].x - 1, self.fruit.pos.x, self.snake[0].y - 1,
                               self.fruit.pos.y))  # Forward Left
            output.append(self.snake[0].x - self.fruit.pos.x - 1)  # Left
    ...
    def generate(self):
        ...
        while not k:
            k = True
            a = random.randrange(0, c.WIDTH/c.BLOCK_SIZE)
            b = random.randrange(0, c.HEIGHT/c.BLOCK_SIZE)
